...
export default function Goals() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', padding: 32 }}>
      ...
      <h1 style={{ color: '#e8e8f0', fontFamily: 'serif', fontSize: 28, marginBottom: 8 }}>◈ Savings Goals</h1>
      <div style={{ background: '#111118', border: '1px solid #1e1e2e', borderRadius: 16, padding: 40, textAlign: 'center', marginTop: 24 }}>
        <div style={{ fontSize: 48, marginBottom: 16 }}>🎯</div>
        <p style={{ color: '#888899', fontSize: 16 }}>Goals tracking coming soon!</p>
        <p style={{ color: '#555566', fontSize: 13, marginTop: 8 }}>Set savings targets for vacation, home, car and more</p>
      </div>
    </div>
  );
}
